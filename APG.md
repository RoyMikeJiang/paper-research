...
![[apg/images/fig_motivation_ctr.png]]
*图：冷启动用户与活跃用户的 CTR 分布差异——冷启动用户高度集中在低 CTR 区间，两类用户的特征分布存在显著差异*

![[apg/images/fig_motivation_age.png]]
...
![[apg/images/fig_optimization_steps.png]]
...
![[apg/images/fig_decomposed_feedforward.png]]
...
![[apg/images/fig_train_vs_inference.png]]
...
![[apg/images/fig_auc_gains_usergroup.png]]
*图：不同用户活跃度分组的离线 AUC 增益——冷启动用户（Group 0）获益最大（+0.58%），活跃用户增益递减但始终为正*

![[apg/images/fig_ctr_gains_usergroup.png]]
